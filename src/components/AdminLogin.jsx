...
const AdminLogin = () => {
    ...
    return (
        <div className={'w-full h-screen flex items-center justify-center'}>
            <form
                className="w-[390px] mx-auto   rounded-lg shadow-2xl py-8 bg-white" onSubmit={handleSubmit}>
                <div className="w-[80%] mx-auto">
                    <h1 className={'text-center font-bold text-3xl mt-4 mb-2'}>Admin Login</h1>
                    <input
